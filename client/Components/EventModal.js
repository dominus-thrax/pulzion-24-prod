  ...
  (
    ...
    return (
      ...
      >
        ...
        ></link>
        <div className="max-w-4xl h-fit m-3 " style={{
          backgroundColor: 'linear-gradient(to top right,red,green)',
          margin: "15px auto 0px"
        }}>
          <div
            className="w-md text-white rounded-3xl shadow-[0px_0px_15px_5px] event-modal"
            style={{
              // top: "50%",
              // left: "50%",
          ...
          >
            ...
            {slots?.length > 0 ? (
              ...
              >
                ...
                {/* Combo Box */}
                <div className="commbo_box">
                  <h5 className="text-xl font-bold text-white ">Event Combo</h5>
                </div>

              </div>
            )}
            <div
              className="flex items-center mb-0 justify-center py-2 shadow-lg rounded-b-3xl bg-black/[.7]"
              style={{
                height: "10%",
              }}
            >
